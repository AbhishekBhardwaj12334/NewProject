...
const MoreScreenAdmin = ({ navigation }) => {
                                    ...
                                    >
                                        ...
                                        >
                                            <Image
                                                ...
                                                style={{ width: 18, height: 20, resizeMode:'contain' }}
                                            />
                                            <Text style={{left:15,fontSize:15,fontFamily:Fonts.FONTS_MEDIUM,color:'black'}}>View My Work</Text>
                                        </View>
                                        <Image
                                            source={require('../../assets/icons/arrowRight.png')}
                                            style={{ width: 15, resizeMode: 'contain' }}
...
export default MoreScreenAdmin;