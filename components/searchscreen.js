        ...
        <View style={styles.viewMain}>
          ...
          <View style={styles.view4}>
            ...
            {/* <View style={{flexDirection:'row',justifyContent:'space-between',paddingHorizontal:10,paddingTop:20}}>
                ...
                >
                    <View style={{flexDirection:'row',backgroundColor:'#2D8AEE',paddingVertical:9,paddingHorizontal:40,alignItems:'center',borderRadius:8}}>
                        <Image
                ...
                <TouchableOpacity
                    style={{paddingVertical:10,}}
                >
                    <View style={{flexDirection:'row',backgroundColor:'#F9B116',paddingVertical:9,paddingHorizontal:40,alignItems:'center',borderRadius:8}}>
                        <Image
