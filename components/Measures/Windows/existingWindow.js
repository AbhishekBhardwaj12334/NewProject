...
const ExistingWindow = ({ navigation }) => {
    ...
    const data = useSelector(state => state.windowOptionsData.windowOptionsArray.replacingExistingWindow)

    const [existingWindow, setExistingWindow] = useState(data);
    ...
    //     const otherOptionIndex = existingWindow.findIndex(option => option.optionsId ? option.value === 'Other' : null);
    //     const otherOption = existingWindow[otherOptionIndex];
    //     const newOptionId = otherOption.optionsId;
    //     const incrementedOtherOptionId = Math.max(...existingWindow.map(option => option.optionsId)) + 1;
    ...
    //     const updatedData = [
    //         ...existingWindow.slice(0, otherOptionIndex),
    //         newOption,
    //         updatedOtherOption,
    //         ...existingWindow.slice(otherOptionIndex + 1)
    //     ];
    //     setExistingWindow(updatedData);
    //     setOtherText('');
